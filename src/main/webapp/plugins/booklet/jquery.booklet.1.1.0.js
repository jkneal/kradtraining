...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	b.data('booklet',true);
	b.data('id', id);
	b.data('total', src.children(".b-loadPage").length);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	opts.pTotal  = src.find(".b-loadPage").length;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function initPages(){		
		...
		if((src.children(".b-loadPage").length % 2) != 0){
			//if book is closed and using covers, add page before back cover, else after last page
			if(opts.closed && opts.covers){
				src.children(".b-loadPage").last().before(blank);
			}else{
				src.children(".b-loadPage").last().after(blank);
			}
		}
		...
		if(opts.closed){
			...
			src.children(".b-loadPage").last().attr({'title':opts.closedBackTitle || "End", 'rel':opts.closedBackChapter || "End of Book"});
			src.append(empty);		
		}
		...
		if(opts.direction == 'LTR'){
			...
			j = src.children(".b-loadPage").length;
			if(opts.closed){j-=2;}
			if(opts.covers){j-=2;}
			$(src.children(".b-loadPage").get().reverse()).each(function(){
				$(this).appendTo(src);
			});
		}
			
		//save titles and chapters
		src.children(".b-loadPage").each(function(i){
			//save chapter title
			if($(this).attr('rel')){
			...
			}else if(opts.closed && opts.covers && (i == 1 || i == src.children(".b-loadPage").length-2)){
