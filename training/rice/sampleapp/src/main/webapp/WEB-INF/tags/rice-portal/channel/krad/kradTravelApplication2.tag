...
<div class="body">
  ...
  <ul class="chan">
    <li><a class="portal_link" target="_blank" href="${ConfigProperties.application.url}/kr-krad/inquiry?methodToCall=start&number=a14&dataObjectClassName=edu.sampleu.travel.bo.TravelAccount&viewName=ks_inquiry"/>Travel Account Inquiry</a></li>
    ...
    <li><portal:portalLink displayTitle="true" title="Travel Authorization Document" url="${ConfigProperties.application.url}/kr-krad/approval?methodToCall=docHandler&command=initiate&documentClass=edu.sampleu.travel.approval.TravelAuthorizationDocument"/></li>
  </ul>
